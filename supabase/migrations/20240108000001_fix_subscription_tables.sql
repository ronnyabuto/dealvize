-- Fix Subscription Tables Migration
-- Migration: 20240108000001_fix_subscription_tables
...
-- Subscription events table for audit trail (FIXED: UUID reference)
CREATE TABLE subscription_events (
    id UUID DEFAULT gen_random_uuid() PRIMARY KEY,
    subscription_id UUID REFERENCES subscriptions(id) ON DELETE CASCADE,  -- FIXED: UUID not TEXT
...
-- Create function to automatically update updated_at timestamp (check if exists first)
